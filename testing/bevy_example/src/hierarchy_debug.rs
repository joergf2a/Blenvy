...
pub fn draw_hierarchy_debug(
    ...
    let entity = display.single();
    *writer.text(entity, 1) = hierarchy_display.join("\n");
    //let mut display = display.single_mut();
    //display.0.sections[0].value = hierarchy_display.join("\n");
}
...
- material extras:  {:?}
        ...
        let entity = display.single();
        *writer.text(entity, 1) = gltf_extra_infos_lines.join("\n");
        //let mut display = display.single_mut();
...
fn __check_for_component(
    ...
    let entity = display.single();
    *writer.text(entity, 1) = info_lines.join("\n");
    //let mut display = display.single_mut();
